...
public class Component {
    ...
    public final static int FIRE = 12;
    ...
    public final static int STARTSPRINKLER = 96;
    public final static int STOPSPRINKLER = 95;
    ...
    public final static int FIRE_CONTROLLER = 13;
